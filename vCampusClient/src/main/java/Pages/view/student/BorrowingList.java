...
public class BorrowingList extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BorrowingList frame = new BorrowingList();
	...
	public BorrowingList() {
		...
		lblNewLabel_3.setBounds(265, 333, 59, 30);
	...
	protected void deletebutton(ActionEvent ae) {
		...
		if(JOptionPane.showConfirmDialog(this, "是否取消申请?","正在取消申请...",JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
...
//搜索按钮响应，后台获取数据
	protected void SelectSomeone(ActionEvent ae) {
		// TODO Auto-generated method stub
		String id=this.TextFile0.getText();//书籍ID
		String textfile1=this.TextFile1.getText();//书名
		String textfile2=this.TextFile2.getText();//作者
		
		String textfile3=this.TextFile3.getText();//ISBN
		String textfile4=this.TextFile4.getText();//分类后台由此获取输入框数据
