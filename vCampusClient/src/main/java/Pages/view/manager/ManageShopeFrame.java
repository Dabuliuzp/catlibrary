...
public class ManageShopeFrame extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ManageShopeFrame frame = new ManageShopeFrame();
	...
	public ManageShopeFrame() {
		...
		lblNewLabel_1_1.setBounds(265, 333, 59, 30);
		getContentPane().add(lblNewLabel_1_1);
		
		TextFile0 = new JTextField();
		TextFile0.setColumns(10);
		TextFile0.setBounds(322, 336, 158, 25);
	...
	protected void AddButton(ActionEvent ae) {
		try{
			...
			String textfile2=this.TextFile2.getText();//价格
			String textfile3=this.TextFile3.getText();//库存

			out.writeObject("3");
			out.writeObject("AddGoods");
			out.writeObject(id);
