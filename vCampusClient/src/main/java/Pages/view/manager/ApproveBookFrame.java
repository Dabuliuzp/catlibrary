...
public class ApproveBookFrame extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ApproveBookFrame frame = new ApproveBookFrame();
	...
	public ApproveBookFrame() {
		...
		JLabel lblNewLabel_1 = new JLabel("借阅人姓名");
		...
		JLabel lblNewLabel_3 = new JLabel("借阅者ID");
		...
		JLabel lblNewLabel_1_1 = new JLabel("申请记录ID");
		lblNewLabel_1_1.setBounds(10, 373, 74, 30);
	...
	//审批按钮响应，后台获取前端用户选择数据。注释同上
	protected void deletebutton(ActionEvent ae) {
		// TODO Auto-generated method stub
		//弹出确认对话框，对话框的的响应
		
		
		if(JOptionPane.showConfirmDialog(this, "是否同意?","正在处理...",JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
			String id =this.TextFile0.getText();
			
				JOptionPane.showMessageDialog(this,"已同意借阅申请");
				requestAllClass();
