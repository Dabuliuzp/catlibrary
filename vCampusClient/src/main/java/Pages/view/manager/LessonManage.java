...
public class LessonManage extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					LessonManage frame = new LessonManage();
	...
	public LessonManage() {
		...
		lblNewLabel_1.setBounds(10, 338, 66, 30);
		...
		JLabel lblNewLabel_4 = new JLabel("课容量");
		lblNewLabel_4.setBounds(10, 378, 59, 30);
		...
		TextFile4.setBounds(322, 338, 158, 25);
		TextFile4.setColumns(10);
		getContentPane().add(TextFile4);

		TextFile5 = new JTextField();
		TextFile5.setBounds(83, 378, 158, 25);
		TextFile5.setColumns(10);
		getContentPane().add(TextFile5);
		...
		lblNewLabel_1_1.setBounds(265, 378, 59, 30);
		getContentPane().add(lblNewLabel_1_1);
		
		TextFile0 = new JTextField();
		TextFile0.setColumns(10);
		TextFile0.setBounds(322, 378, 158, 25);
	...
	protected void AddButton(ActionEvent ae) {
		try{
			...
			String textfile4=this.TextFile4.getText();//课程安排
			String textfile5=this.TextFile5.getText();//课容量
	...
	protected void selectRow(MouseEvent me) {
		...
		this.TextFile5.setText(dtm.getValueAt(this.ClassListTable.getSelectedRow(),  5).toString());
