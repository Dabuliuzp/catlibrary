...
public class ApproveStudentFrame extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ApproveStudentFrame frame = new ApproveStudentFrame();
	...
	public ApproveStudentFrame() {
		...
		JLabel lblNewLabel_2 = new JLabel("所属年级及专业");
		lblNewLabel_2.setBounds(234, 298, 90, 30);
		getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("学籍变动情况");
		lblNewLabel_3.setBounds(234, 333, 90, 30);
		...
		TextFile0.setBounds(66, 376, 158, 25);
	...
	//处理申请按钮响应，后台获取前端用户选择数据。注释同上
	protected void deletebutton(ActionEvent ae) {
		// TODO Auto-generated method stub
		//弹出确认对话框，对话框的的响应
		
		
		if(JOptionPane.showConfirmDialog(this, "是否拒绝申请?","正在处理...",JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
